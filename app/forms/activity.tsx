		...
		>
			<View style={formStyles.progressContainer}>
				...
				<View style={[formStyles.progressStep, formStyles.progressStepActive]}>
					<Text style={formStyles.progressStepText}>9</Text>
				</View>
				<View style={formStyles.progressStep}>
			...
			<Text style={formStyles.header}>What did you do together?</Text>

			<TextInput
				style={formStyles.input}
				placeholder="e.g., Dinner, Coffee, Walk, Movie, etc."
				value={formData.activity}
				onChangeText={(text: string) => updateFormData("activity", text)}
			...
			<TouchableOpacity
				style={[
					...
					!formData.activity.trim() && { backgroundColor: "#ccc" },
				]}
				onPress={handleNext}
