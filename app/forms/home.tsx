	...
	return (
		...
		>
			...
			<TextInput
				...
				placeholder="e.g., New York, California, or Country"
				value={formData.home}
				onChangeText={(text: string) => updateFormData("home", text)}
			...
			<TouchableOpacity
				style={[
					...
					!formData.home.trim() && { backgroundColor: "#ccc" },
				]}
				onPress={handleNext}
				disabled={!formData.home.trim()}
			>
